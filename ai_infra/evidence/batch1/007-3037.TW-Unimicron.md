# 3037.TW Unimicron evidence card
...
| 公司 / 证券代码 | Unimicron / 3037.TW |
| 市场 / 资产池 | 台湾 / 卫星资产池 |
| BFS depth | D3 |
| 产业链模块 | ABF substrate / PCB |
| 当前分池 | 核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | GPU/ASIC package → ABF/substrate → capacity/margin |
| Dependency edge | BOM边+产能边 |
| ETF clue | Taiwan/semis ETFs |
| Smart money clue | IBKR台股需权限 |
