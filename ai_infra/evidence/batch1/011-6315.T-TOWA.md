...
| 市场 / 资产池 | 日本 / 卫星资产池 |
| BFS depth | D3 |
| 产业链模块 | Molding/advanced packaging equipment |
| 当前分池 | 核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | HBM/CoWoS → molding/compression equipment → orders |
| Dependency edge | 产能边+技术边 |
| ETF clue | Japan semis/small cap ETFs |
