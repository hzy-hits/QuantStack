...
| 字段 | 内容 |
| --- | --- |
| Dependency path | custom ASIC/AI chip complexity → EDA/IP → design revenue |
| Dependency edge | 技术边+现金流边 |
| ETF clue | SMH/SOXX/tech ETFs |
| Smart money clue | 13F大盘 |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: AI chip design mix |
| 主要反证 | 估值、客户CapEx周期 |
