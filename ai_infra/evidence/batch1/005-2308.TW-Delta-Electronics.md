# 2308.TW Delta Electronics evidence card
...
| 公司 / 证券代码 | Delta Electronics / 2308.TW |
| 市场 / 资产池 | 台湾 / 卫星资产池 |
| BFS depth | D2-D3 |
| 产业链模块 | Power supply + thermal |
| 当前分池 | 核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | AI rack kW → power shelf/PSU/thermal → revenue |
| Dependency edge | BOM边+技术边 |
| ETF clue | Taiwan/GRID/AI infra ETFs |
| Smart money clue | IBKR台股; ADR? |
