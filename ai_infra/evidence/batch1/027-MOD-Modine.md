...
| 字段 | 内容 |
| --- | --- |
| Dependency path | AI rack heat density → liquid/air cooling → data center thermal revenue |
| Dependency edge | 客户边+技术边 |
| ETF clue | industrial/AI infra ETFs待查 |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: DC mix/margins |
| 主要反证 | 冷却标准化、价格战、非AI业务混杂 |
