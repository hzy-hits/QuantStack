...
| 公司 / 证券代码 | ASMPT / 0522.HK |
| 市场 / 资产池 | H股 / 中国资产池 |
| BFS depth | D3 |
| 产业链模块 | Packaging equipment / TCB |
| 当前分池 | 核心候选 |
| Universe score | 98 / core_review |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | HBM/advanced packaging → TCB/assembly equipment → orders |
| Dependency edge | 产能边+技术边 |
| ETF clue | HK/semis equipment ETFs待查 |
| Smart money clue | 港股通/主动基金 |
