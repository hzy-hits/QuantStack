...
| 公司 / 证券代码 | DISCO / 6146.T |
| 市场 / 资产池 | 日本 / 卫星资产池 |
| BFS depth | D3 |
| 产业链模块 | Dicing/grinding/thinning |
| 当前分池 | 核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | HBM/advanced packaging → wafer thinning/dicing → equipment demand |
