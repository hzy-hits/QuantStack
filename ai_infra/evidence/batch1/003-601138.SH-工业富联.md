...
| 公司 / 证券代码 | 工业富联 / 601138.SH |
| 市场 / 资产池 | A股主板 / 中国资产池 |
| BFS depth | D2 |
| 产业链模块 | AI server/rack manufacturing |
| 当前分池 | 候选/核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | GPU allocation → AI server/rack integration → shipment/revenue |
| Dependency edge | 客户边+BOM边+现金流边 |
| ETF clue | 中国/台湾/AI server ETFs待查 |
| Smart money clue | 陆股通/主动基金/ETF持仓待查 |
...
| Primary sources to find | annual report / quarterly results / customer concentration note / inventory and margin disclosure |
| Metrics to verify | AI server revenue; rack-scale shipment; inventory; gross margin; customer concentration; liquid-cooled rack mix |
| Upgrade conditions | AI server/rack revenue and margins are disclosed, backlog converts to revenue, and inventory risk is controlled. |
| Downgrade conditions | Revenue grows but margin compresses, inventory rises, or business remains low-margin assembly without bottleneck power. |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: AI server revenue/margins/customer concentration |
| 主要反证 | 低毛利组装、库存、客户集中 |
