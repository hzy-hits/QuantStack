# LITE Lumentum US alpha evidence card
...
| company | Lumentum |
| BFS depth | D2-D3 |
| module | Lasers/datacom optics |
| cluster | optics_connectivity |
| current pool | 候选池 |
| total score | 93 |
...
| 方向 | 条件 |
| --- | --- |
| 升级 | Original sources show AI datacenter mix, qualified products, durable customer demand, and margin support. |
| 降级 | Revenue is telecom recovery, one-customer ramp, ASP compression, or CPO timing slips. |

## 当前反证

光模块价格战、客户集中、capex cycle
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: AI datacom revenue/customer qualification |
| 主要反证 | 光模块价格战、客户集中、capex cycle |
| 当前动作 | 先补原文，不做组合动作 |
