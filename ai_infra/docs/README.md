...
这里放稳定方法论、研究规则和模板。优先级高于 `notes`，因为 `notes` 里大多是 ChatGPT Pro 草稿或阶段性整理。

## 入口

| 文件 | 用途 |
| --- | --- |
| [fund-management-philosophy.md](fund-management-philosophy.md) | AI Infra BFS 主题基金研究哲学 |
| [github-repo-operating-model.md](github-repo-operating-model.md) | GitHub 仓库化、迁移和数据安全方案 |
| [public-private-boundary.md](public-private-boundary.md) | 公开 / 私有边界 |
| [data-security-rules.md](data-security-rules.md) | 数据安全规则 |
...
- 改模型和研究规则时，先改这里。
- 具体公司事实不要写进这里，写到 `evidence` 或 `reports`。
- ChatGPT Pro prompt 可以在这里维护，但输出结果应保存在 `notes`。
