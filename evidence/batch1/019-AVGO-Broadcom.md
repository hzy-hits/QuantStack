...
| 公司 / 证券代码 | Broadcom / AVGO |
| 市场 / 资产池 | US / 美国资产池 |
| BFS depth | D1-D2 |
| 产业链模块 | Custom ASIC + networking + CPO |
| 当前分池 | 核心池 |
| Universe score | 99 / core_review |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | Hyperscaler custom ASIC demand → SerDes/switch/CPO → AI cluster fabric |
| Dependency edge | 客户边+技术边+BOM边 |
| ETF clue | SMH/SOXX/AIQ/XLK/QQQ |
| Smart money clue | 13F大盘+AI硬件主题覆盖 |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 合理推论+待原文核验: ASIC/CPO客户与收入拆分需公司原文 |
| 主要反证 | 单客户集中、ASIC项目取消、网络价格竞争 |
