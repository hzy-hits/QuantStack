...
| 字段 | 内容 |
| --- | --- |
| Dependency path | 800G/1.6T demand → precision optical manufacturing → shipment ramp |
| Dependency edge | 客户边+BOM边 |
| ETF clue | AI/industrial/semis ETFs待查 |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: datacom mix/customer risk |
| 主要反证 | 低毛利代工、客户集中、库存 |
