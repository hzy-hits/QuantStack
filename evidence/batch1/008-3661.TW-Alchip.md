...
| 公司 / 证券代码 | Alchip / 3661.TW |
| 市场 / 资产池 | 台湾 / 卫星资产池 |
| BFS depth | D3 |
| 产业链模块 | ASIC design service |
| 当前分池 | 核心候选 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | hyperscaler custom ASIC → design service/NRE → revenue |
| Dependency edge | 客户边+技术边 |
| ETF clue | Taiwan semis ETFs |
| Smart money clue | IBKR台股; active funds |
...
| 原文已证明 |  |
| 合理推论 |  |
| 待原文核验 | 待原文核验: customer concentration/tape-outs |
| 主要反证 | 客户集中、project delay |
