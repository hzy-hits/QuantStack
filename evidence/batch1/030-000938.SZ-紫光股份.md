...
| 市场 / 资产池 | A股主板 / 中国资产池 |
| BFS depth | D2-D3 |
| 产业链模块 | Network/server/cloud infra |
| 当前分池 | 候选/雷达池 |
...
| 字段 | 内容 |
| --- | --- |
| Dependency path | AI DC buildout → networking/server/integration → revenue |
| Dependency edge | 客户边+技术边 |
| ETF clue | A股计算机/通信ETF |
| Smart money clue | 公募/北向待查 |
